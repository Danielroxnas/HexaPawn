...
using System.Linq;
using static HexaPawnConsole.BoardService;
...
namespace HexaPawnTests
{
    public class BoardTests
    {
        ...
        public void Setup()
        {
            _sut = new BoardService(Mock.Of<IBoardState>(), Mock.Of<IMoveService>());
        ...
        public void It_should_move_piece_forward_direction_based_if_white()
        {
            ...
            Assert.That(_sut.Pieces[0, 0], Is.EqualTo(Color.Empty));
            Assert.That(_sut.Pieces[1, 0], Is.EqualTo(Color.White));
        }

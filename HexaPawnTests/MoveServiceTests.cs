...
namespace HexaPawnTests
{
    public class MoveServiceTests
    {
        ...
        public void It_should_move_piece_forward_direction_based_if_white()
        {
            ...
            var result = _sut.MoveForward(2, 0, (int)Color.White, _boardService.Pieces);
            Assert.That(result, Is.EqualTo(true));
            Assert.That(_boardService.Pieces[1, 0], Is.EqualTo((int)Color.White));
            Assert.That(_boardService.Pieces[2, 0], Is.EqualTo((int)Color.Empty));
        }

        [Test]
        public void It_should_move_piece_forward_direction_based_if_black()
        {
            var result = _sut.MoveForward(0, 0, (int)Color.Black, _boardService.Pieces);

            Assert.That(result, Is.EqualTo(true));
            Assert.That(_boardService.Pieces[1, 0], Is.EqualTo((int)Color.Black));
            Assert.That(_boardService.Pieces[0, 0], Is.EqualTo((int)Color.Empty));
        }
        ...
        public void It_should_not_move_piece_forward_if_blocked(int piece)
        {
            ...
            var result = _sut.MoveForward(0, 0, (int)Color.White, _boardService.Pieces);
